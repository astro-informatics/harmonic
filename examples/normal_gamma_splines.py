...
def run_example(ndim=2, nchains=100, samples_per_chain=1000,
	...
	for i_tau, tau_prior in enumerate(tau_array):
		...
		if plot_corner:
			...
			if savefigs:
				plt.savefig('examples/plots/splines_normalgamma_corner_tau' +
							str(tau_prior) +
							'.pdf',
							bbox_inches='tight')
			...
			if savefigs:
				plt.savefig('examples/plots/splines_normalgamma_getdist_tau' +
							str(tau_prior) +
							'.pdf',
							bbox_inches='tight')
			...
			if savefigs:
				plt.savefig('examples/plots/splines_normalgamma_corner_all_'+ str(var_scale)+'tau'+
							str(tau_prior) +'.png',
		...
		if plot_surface:
			...
			if savefigs:
				plt.savefig('examples/plots/' +
							'splines_normalgamma_posterior_image' +
							str(tau_prior) + '.png',
							bbox_inches='tight')
			...
			if savefigs:
				plt.savefig('examples/plots/' +
							'splines_normalgamma_model_image' +
							str(tau_prior) +
							'.png',
							bbox_inches='tight')
			...
			if savefigs:
				plt.savefig('examples/plots/' +
							'splines_normalgamma_modelexp_image' +
							str(tau_prior) +
							'.png',
							bbox_inches='tight')
	...
	if plot_comparison:
		...
		if savefigs:
			plt.savefig('examples/plots/splines_normalgamma_comparison'+ str(var_scale)+'.pdf',
						bbox_inches='tight')
		plt.show(block=False)
	...
	if plot_comparison_2var:
		...
		if savefigs:
			plt.savefig('examples/plots/splines_normalgamma_comparison_'+ str(var_scale)+ '_' + str(var_scale_2) + '.pdf',
