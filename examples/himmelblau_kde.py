...
def run_example(ndim=2, nchains=100, samples_per_chain=1000, 
    ...
    np.savetxt("examples/data/kurtosis_mean_kde",
                   np.array([kurtosis_mean]))
    np.savetxt("examples/data/kurtosis_std_kde",
                   np.array([kurtosis_std]))
    np.savetxt("examples/data/eff_samp_mean_kde",
                   np.array([eff_samp_mean]))
    np.savetxt("examples/data/eff_samp_std_kde",
                   np.array([eff_samp_std]))
    np.savetxt("examples/data/sqrt_mean_kde",
                   np.array([sqrt_mean]))
    np.savetxt("examples/data/sqrt_std_kde",
                   np.array([sqrt_std]))
